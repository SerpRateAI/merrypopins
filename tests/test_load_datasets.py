...
def test_load_tdm_basic(tmp_path):
    ...
    assert df_root.shape == (1, 7)  # root_name, root_description, root_title, root_author + 3 attrs
    r = df_root.iloc[0]
    ...
    assert df_ch.shape == (1, 7)  # group, channel_id, name, unit, description, datatype, sequence_id
    c = df_ch.iloc[0]
